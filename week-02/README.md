...
Outputs appear in `docs/week-02/`. Press `S` in the normal deck to open speaker view. `instructor-notes.html` provides a continuous reading view of the timetable and discussion notes. `with-notes.html` follows Week 1's notes-view presentation convention.
