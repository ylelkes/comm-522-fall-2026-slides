...
|---|---|---|
| 0–21 minutes | Concept vocabulary: types, elements, and the intension/extension tradeoff | 2–9 |
| 21–30 minutes | Diagnosing mega-concepts and the seven weak everyday definitions | 10–13 |
| 30–54 minutes | Gerring's six criteria, diagnosed one by one, bad example before the name | 14–24 |
| 54–59 minutes | Break | 25 |
| 59–78 minutes | Building a concept: Gerring's strategies and Chaffee's steps, synthesized | 26–31 |
| 78–107 minutes | "Fake news": concept explication enacted on a live, current paper | 32–41 |
| 107–120 minutes | Synthesis, forward link to measurement, and exit discussion | 42–44 |
...
### Slide 2: Two weeks of "tolerance," never defined
...
### Slide 3: Bad concepts break description and causation alike
...
### Slide 4: A concept is not the same thing as a word
...
### Slide 5: Gerring's four elements — same idea, different labels
...
### Slide 6: Whole-class: name the type
...
### Slide 7: Gerring's Figure 5.1: tightening a definition shrinks its reach

Timing: 3 minutes. Elapsed: 13–16 minutes.

Introduce the intension/extension tradeoff using Gerring's own Figure 5.1. When defining attributes are treated as *necessary conditions* (a case must have all of them to qualify), adding attributes to the intension can only shrink or hold constant the extension — never grow it. Start from "democracy = free and fair elections" and ask the class to predict what happens to the set of countries counted as democracies if we add "civil liberties" as a second necessary condition. Answer: the set can only get smaller (or stay the same); some countries with contested-but-illiberal elections now fall out.
...
### Slide 8: Whole-class: predict the tradeoff
...
### Slide 9: Diagnose: "Television is harmful to the political process."
...
### Slide 10: Four standards a scientific concept has to meet
...
### Slide 11: Seven everyday ways people define concepts (part 1)
...
### Slide 12: Seven everyday ways people define concepts (part 2)
...
### Slide 13: Diagnose: "Democracy: a furry, four-legged animal."
...
### Slide 14: Criterion 1: Resonance
...
### Slide 15: Diagnose: is this democracy definition universal?
...
### Slide 17: Diagnose: corporatism, stretched

Timing: 3 minutes. Elapsed: 36–39 minutes.
...
### Slide 18: Criterion 3: Consistency

Timing: 2 minutes. Elapsed: 39–41 minutes.
...
### Slide 19: Diagnose: "the West"

Timing: 2 minutes. Elapsed: 41–43 minutes.
...
### Slide 20: Criterion 4: Fecundity
...
### Slide 21: Diagnose: an alphabet soup of "civic groups"
...
### Slide 22: Criterion 5: Differentiation
...
### Slide 23: Diagnose: an "ideal-type" democracy as a treatment

Timing: 3 minutes. Elapsed: 49–52 minutes.
...
### Slide 24: Criterion 6: Causal utility

Timing: 2 minutes. Elapsed: 52–54 minutes.
...
### Slide 25: Five-minute break

Timing: 5 minutes. Elapsed: 54–59 minutes.
...
### Slide 26: Two answers to "how do you actually build one?"

Timing: 3 minutes. Elapsed: 59–62 minutes.
...
### Slide 27: Step 1–3 aligned: survey, classify, and search the literature

Timing: 3 minutes. Elapsed: 62–65 minutes.
...
### Slide 28: Step 4, the real choice: minimal, maximal, or cumulative

Timing: 4 minutes. Elapsed: 65–69 minutes.
...
*Cumulative* definitions try to split the difference: rank the attributes by how essential each is to the concept (start with the single most essential — free and fair elections — then add successively less essential criteria) and use the count of satisfied attributes as an ordinal scale. This buys some of maximal's degree-sensitivity while keeping minimal's crisp, binary attributes; the cost is that you can't presume equal spacing between levels (an ordinal, not interval, scale), and that ranking attributes by "centrality" is itself a judgment call that may not be fully comprehensive.

Source: Gerring, pp. 134–137, Tables 5.2–5.4.

### Slide 29: Whole-class: which strategy fits "tolerance"?

Timing: 2 minutes. Elapsed: 69–71 minutes.
...
### Slide 30: McLeod & Pan's version: concept → dimensions → indicators

Timing: 4 minutes. Elapsed: 71–75 minutes.

Present McLeod & Pan's Figure 2.1 as their own three-level ladder — and note immediately that it is a third labeling of the *same* structure we now have two versions of (Gerring's term/intension/indicator/extension; Gerring's minimal/maximal/cumulative choice). Here, "television viewing" alone is too complex to relate meaningfully to most effect variables (it's a mega-concept, as diagnosed earlier), so the researcher divides it into *dimensions* — subconcepts capturing particular aspects, specified by whatever theory the concept serves (news viewing vs. entertainment viewing, in this case) — and each dimension gets its own concrete *indicators* (specific shows or content types, each measurable, ideally by more than one method).

Walk through why dimensionalizing matters theoretically, not just practically: McLeod & Pan report that news viewing and entertainment viewing turn out to relate to political-knowledge and crime-fear outcomes in opposite directions — a finding invisible if "television viewing" were left as one undifferentiated variable. Specifying dimensions is not merely more precise measurement; it can reveal that a single mega-concept was actually hiding two variables with opposite effects, which is exactly the failure mode we diagnosed in "television is harmful" at the start of class.
...
### Slide 31: The synthesis: it's the same choice, three vocabularies

Timing: 3 minutes. Elapsed: 75–78 minutes.
...
### Slide 32: "Fake news" is a mega-concept, and it's costing us
...
### Slide 33: A serious prior attempt: two dimensions

Timing: 4 minutes. Elapsed: 81–85 minutes.
...
### Slide 34: Chaffee's step 1, enacted: is "fake news" even one variable?

Timing: 3 minutes. Elapsed: 85–88 minutes.
...
### Slide 35: Chaffee's step 2, enacted: searching the literature

Timing: 2 minutes. Elapsed: 88–90 minutes.
...
### Slide 36: Chaffee's step 4, enacted: a minimal definition of real news

Timing: 3 minutes. Elapsed: 90–93 minutes.
...
### Slide 37: Real news, made concrete: four domains of indicators
...
### Slide 38: False news, defined by contrast
...
### Slide 39: Contrast case 1: why isn't satire "false news"?

Timing: 3 minutes. Elapsed: 99–102 minutes.
...
### Slide 40: Contrast case 2: why isn't polarized content "false news"?

Timing: 3 minutes. Elapsed: 102–105 minutes.
...
### Slide 41: Whole-class: classify a headline

Timing: 2 minutes. Elapsed: 105–107 minutes.
...
### Slide 42: Concepts come before explanation, not after

Timing: 3 minutes. Elapsed: 107–110 minutes.
...
### Slide 43: What's still missing: operationalization

Timing: 5 minutes. Elapsed: 110–115 minutes.
...
### Slide 44: Exit prompt

Timing: 5 minutes. Elapsed: 115–120 minutes.
