...
**Maximal** — every non-idiosyncratic attribute, ideal-type: democracy scored across all six families in Table 5.3. Rich, but a matter of degree.

**Cumulative** — attributes ranked by centrality into an ordinal scale: start with elections, add eight more criteria in descending importance.
...
## McLeod & Pan's version: concept → dimensions → indicators

**Concept** (high abstraction): television viewing

**Dimensions** (intermediate): news viewing · entertainment viewing

**Indicators** (low, concrete): days/week watching national news · days/week watching soap operas
